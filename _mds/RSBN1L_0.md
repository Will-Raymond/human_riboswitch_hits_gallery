...
<div class="row" >
  ...
  <div class="column_center">
    <img src="../../alns_9.28.22/aln_5HSAA093412_0.763.png?raw=true" alt="UTR-RS hit comparison" style="width:100%">
  </div>
  <div class="column">
...
| <span title="Similarity score calculated from all similarity metrics">Similarity</span>  | - | 0.96 | 0.98 | 0.94 |
| <span title="Ensemble classification via all 19 ML classifiers">Ensemble Norm</span>  | 0.96 | - | - | - |
| <span title="Nupack Mean Free Energy of the secondary structure">MFE</span>  | -7.23 | -4.72 | -10.70 | -6.10 |
...
| | 5'UTR       | RS match 1   | RS match 2  | RS match 3 |
| ---- | ----------- | ----------- | ----------- | ----------- |
| <span title="Structural feature squared error">Struct SE</span> | - | 0.02 | 3.23 | 0.01 |
...
| <span title="Unpaired nucleotide %">UN</span> | 0.48 | 0.34 | 0 | 0.39 |

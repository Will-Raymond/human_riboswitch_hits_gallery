...
<div class="row" >
  <div class="column">
    <a href="../../_mds/%s/"><img src="../../icons/arrow_left.png" alt="arrow left to previous 5prime UTR page" style="width:100%%"></a>
  </div>
  <div class="column_center">
    <table>
      ...
      <tr>
        <td><img src="../../alns/dot/UTR_%s_%s.png" alt="image of 5prime UTR secondary structure" style="width:100%%"></td>
        <td><img src="../../alns/dot/RS_%s_%s.png" alt="image of the secondary structure of the first Riboswitch match" style="width:100%%"></td>
        <td><img src="../../alns/dot/RS_%s_%s.png" alt="image of the secondary structure of the second Riboswitch match" style="width:100%%"></td>
        <td><img src="../../alns/dot/RS_%s_%s.png" alt="image of the secondary structure of the third Riboswitch match" style="width:100%%"></td>
      </tr>
      <tr>
        <td><img src="../../alns/circ/circ_%s_%s.png" alt="circular plot of the 5prime UTR base pairs" style="width:100%%"></td>
        <td><img src="../../alns/circ/circ_%s_%s.png" alt="circular plot of the 5prime UTR base pairs compared with the first Riboswitch base pairs" style="width:100%%"></td>
        <td><img src="../../alns/circ/circ_%s_%s.png" alt="circular plot of the 5prime UTR base pairs compared with the second Riboswitch base pairs" style="width:100%%"></td>
        <td><img src="../../alns/circ/circ_%s_%s.png" alt="circular plot of the 5prime UTR base pairs compared with the third Riboswitch base pairs" style="width:100%%"></td>
      </tr>
      <tr>
        <td></td>
        <td><img src="../../alns/feat/feat_%s_%s.png" alt="line plot comparing the structural features of the 5prime UTR with its first riboswitch match" style="width:100%%"></td>
        <td><img src="../../alns/feat/feat_%s_%s.png" alt="line plot comparing the structural features of the 5prime UTR with its second riboswitch match" style="width:100%%"></td>
        <td><img src="../../alns/feat/feat_%s_%s.png" alt="line plot comparing the structural features of the 5prime UTR with its third riboswitch match" style="width:100%%"></td>
      </tr>
    </table>
    </div>
  <div class="column">
    <a href="../../_mds/%s/"><img src="../../icons/arrow_right.png" alt="arrow right to the next 5prime UTR page" style="width:100%%"></a>
  </div>
</div>
...
<div class="row" >
    <div class="column_center">
        <img src="../../alns/feat/featcomp_%s.png" alt="heatmap comparing sequence features of the 5prime UTR and top three riboswitch matches" style="width:60%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
</div>

<div class="row" >
    <div class="column_center">
        <img src="../../alns/bpp/bpp_%s.png" alt="Heatmap of base pair probabilities for 1000 computational NUPACK foldings of the 5prime UTR" style="width:50%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
</div>

<div class="row" >
    <div class="column">
        <img src="../../alns/bpp/bpp_%s_unbound.png" alt="Heatmap of base pair probabilities for computational NUPACK foldings of the 5prime UTR that leave the start codon unbound" style="width:100%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
    <div class="column">
        <img src="../../alns/bpp/bpp_%s_bound.png" alt="Heatmap of base pair probabilities for computational NUPACK foldings of the 5prime UTR that leave the start codon bound" style="width:100%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
    <div class="column">
        <img src="../../alns/bpp/bpp_%s_merge.png" alt="Heatmap of base pair probabilities for computational NUPACK foldings of the 5prime UTR with the bound and unbound conformers overlaid" style="width:100%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
</div>
...
<div class="row">
    <div class="column_center">
        <img src="../../alns/ens/ens_%s.png" alt="ML ensemble output for the 5prime UTR" style="width:60%%; display:block; margin-left:auto; margin-right:auto;">
    </div>
</div>
